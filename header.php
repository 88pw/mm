      ...
      <div class="main-slider">
        <div class="main-slider__inner wrap__main">
            <div id="js-main-slider" class="pogoSlider">
              ...
              <div class="pogoSlider-slide main-res__sp" data-transition="zipReveal" data-duration="1000"  style="background-image:url(./wp-content/themes/monday/assets/shaken/shaken-main-sp.jpg);"></div>
              <div class="pogoSlider-slide main-res__sp" data-transition="zipReveal" data-duration="1000"  style="background-image:url(./wp-content/themes/monday/assets/seibi/seibi-main-sp.jpg);"></div>
              <div class="pogoSlider-slide main-res__sp" data-transition="zipReveal" data-duration="1000"  style="background-image:url(./wp-content/themes/monday/assets/about/about-main-sp.jpg);"></div>
      ...
      <div class="main-slider">
        <div class="main-slider__inner wrap__main">
            <div id="js-main-slider" class="pogoSlider">
              ...
              <div class="pogoSlider-slide main-res__pc" data-transition="zipReveal" data-duration="1000"  style="background-image:url(./wp-content/themes/monday/assets/shaken/shaken-main.jpg);"></div>
              <div class="pogoSlider-slide main-res__pc" data-transition="zipReveal" data-duration="1000"  style="background-image:url(./wp-content/themes/monday/assets/seibi/seibi-main.jpg);"></div>
              <div class="pogoSlider-slide main-res__pc" data-transition="zipReveal" data-duration="1000"  style="background-image:url(./wp-content/themes/monday/assets/about/about-main.jpg);"></div>
